...
export default async function ReceivedFeedbackPage({ params }: { params: { id: string } }) {
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="text-sm text-gray-600">
            From: <span className="font-medium text-gray-900">{feedback.sender.name}</span> ({feedback.sender.role})
          </div>
